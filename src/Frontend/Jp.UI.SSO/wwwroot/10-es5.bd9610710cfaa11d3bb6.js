...
var UserAddComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserAddComponent.prototype.ngOnInit = function () {
        ...
        this.registerForm.controls.email.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(500))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function (a) { return _this.userService.checkEmail(a); }))
        ...
        this.registerForm.controls.userName.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(500))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function (a) { return _this.userService.checkUserName(a); }))
    ...
    UserAddComponent.prototype.save = function () {
        ...
        this.userService.save(this.registerForm.value).subscribe(function (registerResult) {
            ...
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_5__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
...
var UserClaimsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserClaimsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (p) { return _this.userName = p["username"]; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (p) { return p["username"]; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["flatMap"])(function (m) { return _this.userService.getUserClaims(m.toString()); })).subscribe(function (result) { return _this.claims = result; });
        this.errors = [];
    ...
    UserClaimsComponent.prototype.save = function () {
        ...
        this.userService.saveClaim(this.userName, this.model).subscribe(function (registerResult) {
            if (registerResult) {
                _this.showSuccessMessage();
                _this.loadClaims();
                _this.model = new _shared_viewModel_claim_model__WEBPACK_IMPORTED_MODULE_2__["Claim"]();
            }
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_3__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
...
var UserEditComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (p) { return _this.username = p["username"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["flatMap"])(function (p) { return _this.userService.getDetails(p["username"]); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (user) { return _this.patchObserver = fast_json_patch__WEBPACK_IMPORTED_MODULE_5__["observe"](user); })).subscribe(function (result) {
            _this.model = result;
            _this.showButtonLoading = false;
    ...
    UserEditComponent.prototype.update = function () {
        ...
        this.errors = [];
        try {
            this.userService.patch(this.username, fast_json_patch__WEBPACK_IMPORTED_MODULE_5__["generate"](this.patchObserver)).subscribe(function () {
                _this.showSuccessMessage();
                _this.router.navigate(["/users"]);
            }, function (err) {
...
var UserEventsComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserEventsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(function (p) { return _this.userService.getDetails(p["username"]); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (user) { return _this.user = user; }))
        ...
        this.eventSearch
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (text) { return _this.userService.searchEvents(_this.user.userName, text, _this.quantity, _this.page); }))
...
var UserListComponent = /** @class */ /*@__PURE__*/ (function () {
    ...
    UserListComponent.prototype.ngOnInit = function () {
        ...
        this.userSearch
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.animateLoadUsers(); }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (a) { return _this.userService.findUsers(a, _this.quantity, _this.page); }))
            .subscribe(function (response) {
    ...
    UserRolesComponent.prototype.save = function () {
        ...
        this.userService.saveRole(this.userName, this.model).subscribe(function (registerResult) {
            if (registerResult) {
                _this.showSuccessMessage();
                _this.loadClaims();
                _this.model = new _shared_viewModel_role_model__WEBPACK_IMPORTED_MODULE_4__["SaveRole"]();
            }
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_3__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });

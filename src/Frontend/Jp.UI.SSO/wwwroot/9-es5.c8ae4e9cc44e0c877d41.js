 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var ImageCropperComponent = /** @class */ /*@__PURE__*/ (function () {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var ImageCropperModule = /** @class */ /*@__PURE__*/ (function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ngx_image_cropper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngx-image-cropper */ "./node_modules/ngx-image-cropper/fesm5/ngx-image-cropper.js");
...
/* harmony import */ var ngx_image_cropper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-image-cropper */ "./node_modules/ngx-image-cropper/fesm5/ngx-image-cropper.js");
...
var ClientAddComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientAddComponent(router, translator, clientService, toasterService, settings) {
        this.router = router;
    ...
    ClientAddComponent.prototype.showSuccessMessage = function () {
        var _this = this;
    ...
    ClientAddComponent.prototype.selectClient = function (type) {
    ...
    ClientAddComponent.prototype.save = function () {
        ...
        this.clientService.save(this.model).subscribe(function (registerResult) {
            if (registerResult) {
                _this.showSuccessMessage();
                _this.router.navigate(['/clients', _this.model.clientId, 'edit']);
            }
    ...
    ClientAddComponent.prototype.fileChangeEvent = function (event) {
    ...
    ClientAddComponent.prototype.imageCropped = function (event) {
        this.fileData = event;
        this.croppedImage = event.base64;
    };
    ClientAddComponent.prototype.imageLoaded = function () {
        this.showCropper = true;
    };
    ClientAddComponent.prototype.loadImageFailed = function () {
        // show message
    };
...
var ClientClaimsComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientClaimsComponent(route, router, translator, clientService, toasterService) {
        this.route = route;
        this.router = router;
        this.translator = translator;
        this.clientService = clientService;
    ...
    ClientClaimsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (p) { return _this.client = p["clientId"]; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (p) { return p["clientId"]; })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["flatMap"])(function (m) { return _this.clientService.getClientClaims(m.toString()); })).subscribe(function (result) { return _this.claims = result; });
        this.errors = [];
    ...
    ClientClaimsComponent.prototype.showSuccessMessage = function () {
        var _this = this;
        this.translator.translate.get('toasterMessages').subscribe(function (a) {
            _this.toasterService.pop("success", a["title-success"], a["message-success"]);
        });
    };
    ClientClaimsComponent.prototype.selectType = function (type) {
        this.model.type = type;
    };
    ClientClaimsComponent.prototype.remove = function (claim) {
        var _this = this;
        this.showButtonLoading = true;
        this.errors = [];
        this.clientService.removeClaim(this.client, claim.type, claim.value).subscribe(function () {
            _this.showSuccessMessage();
            _this.loadClaims();
            _this.showButtonLoading = false;
        }, function (err) {
    ...
    ClientClaimsComponent.prototype.loadClaims = function () {
        var _this = this;
        this.clientService.getClientClaims(this.client).subscribe(function (c) { return _this.claims = c; });
    };
    ClientClaimsComponent.prototype.save = function () {
        var _this = this;
        this.showButtonLoading = true;
        this.errors = [];
        this.model.clientId = this.client;
        this.clientService.saveClaim(this.model).subscribe(function (claims) {
            _this.showSuccessMessage();
            _this.claims = claims;
            _this.model = new _shared_viewModel_client_model__WEBPACK_IMPORTED_MODULE_2__["ClientClaim"]();
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_3__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
            _this.showButtonLoading = false;
...
/* harmony import */ var ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ngx-bootstrap/accordion */ "./node_modules/ngx-bootstrap/accordion/fesm5/ngx-bootstrap-accordion.js");
/* harmony import */ var ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-bootstrap/alert */ "./node_modules/ngx-bootstrap/alert/fesm5/ngx-bootstrap-alert.js");
...
/* harmony import */ var ngx_bootstrap_progressbar__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ngx-bootstrap/progressbar */ "./node_modules/ngx-bootstrap/progressbar/fesm5/ngx-bootstrap-progressbar.js");
...
/* harmony import */ var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ngx-bootstrap/timepicker */ "./node_modules/ngx-bootstrap/timepicker/fesm5/ngx-bootstrap-timepicker.js");
/* harmony import */ var ngx_bootstrap_popover__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-bootstrap/popover */ "./node_modules/ngx-bootstrap/popover/fesm5/ngx-bootstrap-popover.js");
/* harmony import */ var ngx_bootstrap_typeahead__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ngx-bootstrap/typeahead */ "./node_modules/ngx-bootstrap/typeahead/fesm5/ngx-bootstrap-typeahead.js");
...
/* harmony import */ var ngx_chips__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ngx-chips */ "./node_modules/ngx-chips/fesm5/ngx-chips.js");
...
/* harmony import */ var ngx_bootstrap_collapse__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ngx-bootstrap/collapse */ "./node_modules/ngx-bootstrap/collapse/fesm5/ngx-bootstrap-collapse.js");
/* harmony import */ var ngx_bootstrap_buttons__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ngx-bootstrap/buttons */ "./node_modules/ngx-bootstrap/buttons/fesm5/ngx-bootstrap-buttons.js");
/* harmony import */ var ng2_tooltip_directive__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ng2-tooltip-directive */ "./node_modules/ng2-tooltip-directive/fesm5/ng2-tooltip-directive.js");
/* harmony import */ var _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! @ng-select/ng-select */ "./node_modules/@ng-select/ng-select/fesm5/ng-select-ng-select.js");
...
/* harmony import */ var ng2_material_dropdown__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ng2-material-dropdown */ "./node_modules/ng2-material-dropdown/fesm5/ng2-material-dropdown.js");
/* harmony import */ var ngx_image_cropper__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ngx-image-cropper */ "./node_modules/ngx-image-cropper/fesm5/ngx-image-cropper.js");
...
var ClientsModule = /** @class */ /*@__PURE__*/ (function () {
...
var ClientService = /** @class */ /*@__PURE__*/ (function () {
    function ClientService(http) {
        this.http = http;
        this.endpoint = _env_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].ResourceServer + "clients";
    }
    ClientService.prototype.getClients = function () {
        return this.http.get(this.endpoint);
    };
    ClientService.prototype.getClientDetails = function (clientId) {
        return this.http.get(this.endpoint + "/" + clientId);
    };
    ClientService.prototype.save = function (model) {
        return this.http.post(this.endpoint, model);
    };
    ClientService.prototype.update = function (client, model) {
        return this.http.put(this.endpoint + "/" + client, model);
    };
    ClientService.prototype.partialUpdate = function (client, patch) {
        return this.http.patch(this.endpoint + "/" + client, patch);
    };
    ClientService.prototype.copy = function (clientId) {
        var command = {};
        return this.http.post(this.endpoint + "/" + clientId + "/copy", command);
    };
    ClientService.prototype.remove = function (clientId) {
        return this.http.delete(this.endpoint + "/" + clientId);
    };
    ClientService.prototype.getClientSecrets = function (clientId) {
        return this.http.get(this.endpoint + "/" + clientId + "/secrets");
    };
    ClientService.prototype.removeSecret = function (client, type, value) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]()
            .set('type', type)
            .set('value', encodeURIComponent(value));
        return this.http.delete(this.endpoint + "/" + client + "/secrets", { params: params });
    };
    ClientService.prototype.saveSecret = function (model) {
        return this.http.post(this.endpoint + "/" + model.clientId + "/secrets", model);
    };
    ClientService.prototype.getClientProperties = function (clientId) {
        return this.http.get(this.endpoint + "/" + clientId + "/properties");
    };
    ClientService.prototype.removeProperty = function (client, key) {
        return this.http.delete(this.endpoint + "/" + client + "/properties/" + key);
    };
    ClientService.prototype.saveProperty = function (model) {
        return this.http.post(this.endpoint + "/" + model.clientId + "/properties", model);
    };
    ClientService.prototype.getClientClaims = function (clientId) {
        return this.http.get(this.endpoint + "/" + clientId + "/claims");
    };
    ClientService.prototype.removeClaim = function (client, type, value) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]()
            .set('type', type)
            .set('value', value);
        return this.http.delete(this.endpoint + "/" + client + "/claims", { params: params });
    };
    ClientService.prototype.saveClaim = function (model) {
...
/* harmony import */ var ngx_bootstrap_positioning__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-bootstrap/positioning */ "./node_modules/ngx-bootstrap/positioning/fesm5/ngx-bootstrap-positioning.js");
...
var ClientAuthComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientAuthComponent(route, translator) {
        this.route = route;
        this.translator = translator;
    }
    ClientAuthComponent.prototype.ngOnInit = function () {
    };
    ClientAuthComponent.prototype.addIdentityProvidersRestrictions = function (type) {
        if (this.model.identityProviderRestrictions.find(function (a) { return a == type; }) == null)
...
/* harmony import */ var ngx_chips__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-chips */ "./node_modules/ngx-chips/fesm5/ngx-chips.js");
...
var ClientBasicComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientBasicComponent(route, translator, settings) {
        this.route = route;
        this.translator = translator;
        this.settings = settings;
        // Image settings
    ...
    ClientBasicComponent.prototype.ngOnInit = function () {
    };
    ClientBasicComponent.prototype.fileChangeEvent = function (event) {
        if (event == null || event.target == null)
            return;
        var fileToUpload = event.target.files.item(0);
        this.file = fileToUpload;
    ...
    ClientBasicComponent.prototype.imageCropped = function (event) {
    ...
    ClientBasicComponent.prototype.imageLoaded = function () {
        this.showCropper = true;
    };
    ClientBasicComponent.prototype.loadImageFailed = function () {
        // show message
    };
    return ClientBasicComponent;
}());
...
var ClientEditComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientEditComponent(route, router, translator, clientService, toasterService) {
        this.route = route;
        this.router = router;
        this.translator = translator;
        this.clientService = clientService;
    ...
    ClientEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (p) { return _this.clientId = p["clientId"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["flatMap"])(function (p) { return _this.clientService.getClientDetails(p["clientId"]); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (client) { return _this.patchObserver = fast_json_patch__WEBPACK_IMPORTED_MODULE_4__["observe"](client); }))
    ...
    ClientEditComponent.prototype.update = function () {
        ...
        this.showButtonLoading = true;
        this.errors = [];
        this.clientService.update(this.clientId, this.model).subscribe(function () {
            _this.updateCurrentClientId();
            _this.showSuccessMessage();
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_2__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
    ...
    ClientEditComponent.prototype.updateCurrentClientId = function () {
        this.clientId = this.model.clientId;
    };
    ClientEditComponent.prototype.showSuccessMessage = function () {
        var _this = this;
        this.translator.translate.get('toasterMessages').subscribe(function (a) {
            _this.toasterService.pop("success", a["title-success"], a["message-success"]);
        });
...
var ClientDeviceFlowComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientDeviceFlowComponent(route, translator) {
        this.route = route;
        this.translator = translator;
    }
    ClientDeviceFlowComponent.prototype.ngOnInit = function () {
    };
    return ClientDeviceFlowComponent;
}());
...
/* harmony import */ var ngx_bootstrap_popover__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/popover */ "./node_modules/ngx-bootstrap/popover/fesm5/ngx-bootstrap-popover.js");
/* harmony import */ var ngx_bootstrap_component_loader__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-bootstrap/component-loader */ "./node_modules/ngx-bootstrap/component-loader/fesm5/ngx-bootstrap-component-loader.js");
...
var ClientSettingsComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientSettingsComponent(route, translator, scopeService) {
        var _this = this;
        this.route = route;
        this.translator = translator;
        this.scopeService = scopeService;
        this.requestScopeItems = function (text) {
            return _this.scopeService.getScopes(text).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(500)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (a) { return a; }));
        };
    }
    ClientSettingsComponent.prototype.addGrantType = function (type) {
        if (this.model.allowedGrantTypes.find(function (a) { return a == type; }) == null)
            this.model.allowedGrantTypes.push(type);
    };
    ClientSettingsComponent.prototype.ngOnInit = function () {
    };
...
var ClientTokenComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientTokenComponent(route, translator) {
        this.route = route;
        this.translator = translator;
    }
    ClientTokenComponent.prototype.ngOnInit = function () {
...
var ClientListComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientListComponent(translator, clientService) {
        this.translator = translator;
        this.clientService = clientService;
    ...
    ClientListComponent.prototype.ngOnInit = function () {
        ...
        this.clientList$ = this.refresh.asObservable()
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(function (_) { return _this.clientService.getClients(); }));
    };
    ClientListComponent.prototype.loadClients = function () {
        this.refresh.next('refresh');
    };
    ClientListComponent.prototype.copy = function (clientId) {
        var _this = this;
        this.translator.translate.get('client.clone').subscribe(function (m) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
                ...
                if (isConfirm.value) {
                    _this.clientService.copy(clientId).subscribe(function (updatedClient) {
                        _this.loadClients();
    ...
    ClientListComponent.prototype.remove = function (clientId) {
        var _this = this;
        this.translator.translate.get('client.remove').subscribe(function (m) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
                title: m['title'],
                text: m["text"],
                type: 'warning',
                ...
                if (isConfirm.value) {
                    _this.clientService.remove(clientId).subscribe(function () {
                        _this.loadClients();
...
var ClientPropertiesComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientPropertiesComponent(route, router, translator, clientService, toasterService) {
        this.route = route;
        this.router = router;
        this.translator = translator;
        this.clientService = clientService;
    ...
    ClientPropertiesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) { return _this.client = p["clientId"]; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (p) { return p["clientId"]; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(function (m) { return _this.clientService.getClientProperties(m.toString()); }))
            .subscribe(function (result) { return _this.clientProperties = result; });
        this.errors = [];
        this.model = new _shared_viewModel_client_model__WEBPACK_IMPORTED_MODULE_1__["ClientProperty"]();
        this.showButtonLoading = false;
    };
    ClientPropertiesComponent.prototype.showSuccessMessage = function () {
        var _this = this;
        this.translator.translate.get('toasterMessages').subscribe(function (a) {
            _this.toasterService.pop("success", a["title-success"], a["message-success"]);
        });
    };
    ClientPropertiesComponent.prototype.remove = function (key) {
        var _this = this;
        this.showButtonLoading = true;
        this.clientService.removeProperty(this.client, key).subscribe(function () {
            _this.showSuccessMessage();
    ...
    ClientPropertiesComponent.prototype.loadProperties = function () {
        var _this = this;
        this.clientService.getClientProperties(this.client).subscribe(function (c) { return _this.clientProperties = c; });
    };
    ClientPropertiesComponent.prototype.save = function () {
        var _this = this;
        this.showButtonLoading = true;
        this.model.clientId = this.client;
        this.clientService.saveProperty(this.model).subscribe(function (properties) {
            _this.showSuccessMessage();
            _this.clientProperties = properties;
            _this.model = new _shared_viewModel_client_model__WEBPACK_IMPORTED_MODULE_1__["ClientProperty"]();
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_2__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
            _this.showButtonLoading = false;
    ...
    return ClientPropertiesComponent;
}());
...
var ClientSecretsComponent = /** @class */ /*@__PURE__*/ (function () {
    function ClientSecretsComponent(route, router, translator, clientService, toasterService) {
        this.route = route;
        this.router = router;
        this.translator = translator;
        this.clientService = clientService;
    ...
    ClientSecretsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) { return _this.client = p["clientId"]; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (p) { return p["clientId"]; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(function (m) { return _this.clientService.getClientSecrets(m.toString()); }))
            .subscribe(function (result) { return _this.clientSecrets = result; });
        this.errors = [];
    ...
    ClientSecretsComponent.prototype.showSuccessMessage = function () {
        var _this = this;
        this.translator.translate.get('toasterMessages').subscribe(function (a) {
            _this.toasterService.pop("success", a["title-success"], a["message-success"]);
        });
    };
    ClientSecretsComponent.prototype.remove = function (secret) {
        var _this = this;
        this.showButtonLoading = true;
        this.errors = [];
        this.clientService.removeSecret(this.client, secret.type, secret.value).subscribe(function () {
            _this.showSuccessMessage();
            _this.loadSecrets();
            _this.showButtonLoading = false;
        }, function (err) {
    ...
    ClientSecretsComponent.prototype.loadSecrets = function () {
        var _this = this;
        this.clientService.getClientSecrets(this.client).subscribe(function (c) { return _this.clientSecrets = c; });
    };
    ClientSecretsComponent.prototype.save = function () {
        var _this = this;
        this.showButtonLoading = true;
        this.errors = [];
        this.model.clientId = this.client;
        this.clientService.saveSecret(this.model).subscribe(function (registerResult) {
            _this.showSuccessMessage();
            _this.clientSecrets = registerResult;
            _this.model = new _shared_viewModel_client_model__WEBPACK_IMPORTED_MODULE_1__["ClientSecret"]();
            _this.showButtonLoading = false;
        }, function (err) {
            _this.errors = _shared_viewModel_default_response_model__WEBPACK_IMPORTED_MODULE_2__["ProblemDetails"].GetErrors(err).map(function (a) { return a.value; });
            _this.showButtonLoading = false;
...
var ScopeService = /** @class */ /*@__PURE__*/ (function () {
    function ScopeService(http) {
        this.http = http;
        this.endpoint = _env_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].ResourceServer + "scopes";
    }
    ScopeService.prototype.getScopes = function (text) {
...
/* harmony import */ var _claim_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./claim.model */ "./src/app/shared/viewModel/claim.model.ts");


var ClientSecret = /** @class */ /*@__PURE__*/ (function () {
...
var Subject = /** @class */ /*@__PURE__*/ (function () {
    function Subject() {
    }
    return Subject;
}());

var ClientClaim = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ClientClaim, _super);
    function ClientClaim() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ClientClaim;
}(_claim_model__WEBPACK_IMPORTED_MODULE_1__["Claim"]));
...
var ClientProperty = /** @class */ /*@__PURE__*/ (function () {
    function ClientProperty() {
    }
    return ClientProperty;
}());

var NewClient = /** @class */ /*@__PURE__*/ (function () {
    function NewClient() {
    }
    return NewClient;
}());

var Client = /** @class */ /*@__PURE__*/ (function () {
    function Client() {
    }
    Client.isValid = function (client, errors) {
        errors.length = 0;
        ...
        client.allowedGrantTypes.forEach(function (grant) {
            if (grant.indexOf(' ') >= 0) {
    ...
    Client.findGrantTypes = function (grantA, grantB, grants, errors) {
        if (grants.find(function (g) { return g == grantA; }) != null && grants.find(function (g) { return g == grantB; }) != null)
...
var FileViewModel = /** @class */ /*@__PURE__*/ (function () {
    function FileViewModel(filename, fileType, value) {
